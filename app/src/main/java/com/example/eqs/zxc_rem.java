...
public class zxc_rem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zxc_rem);
        ...
        View.OnClickListener oclbackspaceGamePad = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(zxc_rem.this, remont.class);
        ...
        View.OnClickListener oclcontacts3 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(zxc_rem.this, MainActivity.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclcontacts2 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(zxc_rem.this, pay.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclImgButtonEl = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://a0784668.xsph.ru/index_rem.php"));
        ...
        View.OnClickListener oclcontacts = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(zxc_rem.this, prjob.class);
                startActivity(intent);
            }
        };
