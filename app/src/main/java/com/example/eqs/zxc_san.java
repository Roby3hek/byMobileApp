...
public class zxc_san extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zxc_san);
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i){
                    case R.id.radioButton:
                        itog.setText("4020 рублей");
                        break;
                    case R.id.radioButton2:
                        itog.setText("2500 рублей");
                        break;
                    case R.id.radioButton3:
                        itog.setText("4000 рублей");
                        break;
                }
            }
        });
        ...
        View.OnClickListener oclImgButtonEl = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://a0784668.xsph.ru/index_san.php"));
        ...
        View.OnClickListener oclbackspaceGamePad = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(zxc_san.this, santehnik.class);
        ...
        View.OnClickListener oclcontacts3 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(zxc_san.this, MainActivity.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclcontacts2 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(zxc_san.this, pay.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclcontacts = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(zxc_san.this, prjob.class);
                startActivity(intent);
            }
        };
