    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener oclbackspaceGamePad = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(remont.this, catalog.class);
        ...
        View.OnClickListener oclcontacts3 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(remont.this, MainActivity.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclcontacts2 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(remont.this, pay.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclcontacts = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(remont.this, prjob.class);
                startActivity(intent);
            }
        };
        ...
        ImageButton imgButtonRem = (ImageButton) findViewById(R.id.imgButtonRem);
        View.OnClickListener oclimgButtonRem = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(remont.this, zxc_rem.class);
                startActivity(intent);
            }
        };
        imgButtonRem.setOnClickListener(oclimgButtonRem);
    }
}