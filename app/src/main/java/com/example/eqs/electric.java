    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener oclbackspaceGamePad = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(electric.this, catalog.class);
        ...
        View.OnClickListener oclcontacts3 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(electric.this, MainActivity.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclcontacts2 = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(electric.this, pay.class);
                startActivity(intent);
            }
        };
        ...
        View.OnClickListener oclcontacts = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(electric.this, prjob.class);
                startActivity(intent);
            }
        };
        contacts.setOnClickListener(oclcontacts);

        ImageButton  ImgButtonEl = (ImageButton) findViewById(R.id.ImgButtonEl);

        View.OnClickListener oclImgButtonEl = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(electric.this, zxc_el.class);
                startActivity(intent);
            }
        };
